...
namespace Xamarin_DAW.AndroidUI
{
    public class BitwiseList <T> : List<T>
    {
        ...
        /// </summary>
        public static readonly object ZERO = new Zero();
        /// <summary>
        /// a constant for integer negative one: -1
        /// <br/>
        /// this should be used when testing for bits
        /// </summary>
        public static readonly object NEGATIVE_ONE = new NegativeOne();
        ...
        {
            return HashCode.Combine(Capacity, Count, IS_NOT, shouldCheckInstanceEquality);
        }
