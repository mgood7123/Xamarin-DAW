...
namespace Xamarin_DAW.AndroidUI
{
    ...
    public class View : Xamarin.Forms.BindableObject, Parent
    {
        ...
        public static LayoutParams MATCH_PARENT__MATCH_PARENT => new LayoutParams(MATCH_PARENT, MATCH_PARENT);
        public static LayoutParams MATCH_PARENT__WRAP_CONTENT => new LayoutParams(MATCH_PARENT, WRAP_CONTENT);
        public static LayoutParams WRAP_CONTENT__MATCH_PARENT => new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        public static LayoutParams WRAP_CONTENT__WRAP_CONTENT => new LayoutParams(WRAP_CONTENT, WRAP_CONTENT);
