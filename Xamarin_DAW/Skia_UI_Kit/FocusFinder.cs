...
namespace Xamarin_DAW.Skia_UI_Kit
{
    ...
    {
        [ThreadStatic] private static FocusFinder tlFocusFinder = new FocusFinder();
        ...
        readonly Rect mFocusedRect = new Rect();
        readonly Rect mOtherRect = new Rect();
        readonly Rect mBestCandidateRect = new Rect();
        ...
        private readonly FocusSorter mFocusSorter = new FocusSorter();

        private readonly List<View> mTempList = new List<View>();
